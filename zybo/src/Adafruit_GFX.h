...
#define ARDUINO                                                                \
  150 // Added by BLH to get the #ifdef for write() to work. I'm assuming that
      // 150 means a later version of Arduino.
...
public:
  ...
  virtual void drawLine(int16_t x0, int16_t y0, int16_t x1, int16_t y1,
      ...
      fillScreen(uint16_t color), invertDisplay(bool i);
  ...
  void drawCircle(int16_t x0, int16_t y0, int16_t r, uint16_t color),
      ...
      setTextWrap(bool w), setRotation(uint8_t r);
