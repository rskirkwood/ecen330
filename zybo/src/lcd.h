...
#define LCD_MICROSECOND_DELAY_COUNT                                            \
  649 // Should be approximately 1 microsecond.
#define LCD_MILLISECOND_DELAY_COUNT                                            \
  649000 // Should be approximately 1 millisecond.
...
// These calls are related to the GPIO control block that is dedicated to the
// LCD panel.
void LCD_init();
...
// These calls are related to the data bus pins (GPIO) that are connected to the
// LCD controller.
