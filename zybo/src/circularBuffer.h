...
typedef struct {
  ...
  bool
      firstPassFlag; // True if this is your first write pass through the array.
...
// Reads a data item at the given index. The index is relative, an index of 0
// just means the first element of the circular buffer.
