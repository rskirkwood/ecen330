...
// These defines are used to compute seconds, minutes, etc., from the global
// timer values. The global timer clock is 1/2 the processor frequency (650 MHz
// for ZYBO board
...
// Simple test so that user can verify that the global timer is working
// properly.
