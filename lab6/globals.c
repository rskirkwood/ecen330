...
void globals_setSequence(const uint8_t sequence[], uint16_t length) {
  // set the local sequence equal to the passed in sequence that is generated by
  // simonControl.c
...
uint16_t globals_getSequenceLength() { return global_length; }
...
uint16_t globals_getSequenceIterationLength() { return global_level; }
